...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiTarget, FiBriefcase } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'administrator', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    },
    {
      ...
      path: '/customer-strategies',
      entity: 'customer_strategy',
      service: AccessServiceEnum.PROJECT,
      icon: FiBox,
    },
    { name: 'Strategy', path: '/strategies', entity: 'strategy', service: AccessServiceEnum.PROJECT, icon: FiTarget },
